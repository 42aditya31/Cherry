...
pyautogui.moveTo(690, 750)  # Move to the icon
...
pyautogui.moveTo(522, 175)  # Move to the start position
pyautogui.mouseDown()       # Press and hold the mouse button
pyautogui.moveTo(1274, 590, duration=1)  # Drag to the end position
pyautogui.mouseUp()         # Release the mouse button] '

# Wait briefly to ensure selection is registered
time.sleep(0.5)
pyautogui.click(1274, 590)  
